...
const projectService = {
  ...
  async getProjectByMentorId(
    ...
    return apiUtils.get(
      API_ENDPOINTS_PROJECT.GET_PROJECT_BY_MENTOR_ID(
        mentorId,
        pageSize,
        pageIndex,
        sortDir,
  ...
  async getUserProjectHistory(
    userId,
    { pageIndex = 1, pageSize = 20, sortColumn = "Id", sortDir = "Desc" } = {},
  ) {
    return apiUtils.get(
      API_ENDPOINTS_PROJECT.GET_USER_HISTORY(
        userId,
        pageIndex,
        pageSize,
        sortColumn,
  ...
  async startProject(projectId) {
    return apiUtils.post(API_ENDPOINTS_PROJECT.START_PROJECT(projectId));
  },
